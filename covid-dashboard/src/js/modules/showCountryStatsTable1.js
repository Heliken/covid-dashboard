...
export default (stats) => {
  dom.t1country.textContent = stats.country;
  if (dom.t1radioLastDay.checked) {
    if (dom.t1radioAllPopulation.checked) {
    ...
    } else if (dom.t1radioPer100k.checked) {
  ...
  } else if (dom.t1radioAllTime.checked) {
    if (dom.t1radioAllPopulation.checked) {
